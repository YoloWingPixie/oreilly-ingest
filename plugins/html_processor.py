...
class HtmlProcessorPlugin(Plugin):
    ...
    def _convert_svg_images(self, content, root_soup):
        """Replace SVG <image> with <img>. root_soup is the BeautifulSoup instance (has new_tag)."""
        for image_tag in content.find_all("image"):
